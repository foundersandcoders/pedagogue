...
const css = {
  code: '.container.svelte-1tnnkq8.svelte-1tnnkq8{max-width:1000px;margin:0 auto}header.svelte-1tnnkq8.svelte-1tnnkq8{text-align:center;margin-bottom:3rem}header.svelte-1tnnkq8 h1.svelte-1tnnkq8{font-size:3rem;color:#333;margin-bottom:0.5rem}header.svelte-1tnnkq8 p.svelte-1tnnkq8{color:#666;font-size:1.1rem}.workflow.svelte-1tnnkq8.svelte-1tnnkq8{background:white;border-radius:12px;box-shadow:0 4px 16px rgba(0, 0, 0, 0.1);overflow:hidden}.steps.svelte-1tnnkq8.svelte-1tnnkq8{display:flex;background:#f8f9fa;padding:1rem;border-bottom:1px solid #e9ecef}.step.svelte-1tnnkq8.svelte-1tnnkq8{display:flex;align-items:center;flex:1;padding:0.5rem;position:relative}.step.svelte-1tnnkq8.svelte-1tnnkq8:not(:last-child)::after{content:"→";position:absolute;right:-0.5rem;color:#ccc;font-weight:bold}.step-number.svelte-1tnnkq8.svelte-1tnnkq8{width:2rem;height:2rem;border-radius:50%;background:#e9ecef;display:flex;align-items:center;justify-content:center;font-weight:bold;margin-right:0.5rem;font-size:0.9rem}.step.active.svelte-1tnnkq8 .step-number.svelte-1tnnkq8{background:#007bff;color:white}.step.completed.svelte-1tnnkq8 .step-number.svelte-1tnnkq8{background:#28a745;color:white}.step-name.svelte-1tnnkq8.svelte-1tnnkq8{font-size:0.9rem;color:#495057}.step.active.svelte-1tnnkq8 .step-name.svelte-1tnnkq8{color:#007bff;font-weight:600}.content.svelte-1tnnkq8.svelte-1tnnkq8{padding:2rem}.upload-section.svelte-1tnnkq8 h2.svelte-1tnnkq8{margin-bottom:1rem;color:#333}.upload-section.svelte-1tnnkq8 p.svelte-1tnnkq8{color:#666;margin-bottom:2rem}.upload-areas.svelte-1tnnkq8.svelte-1tnnkq8{display:grid;grid-template-columns:1fr 1fr 1fr;gap:1.5rem;margin-bottom:2rem}@media(max-width: 1024px){.upload-areas.svelte-1tnnkq8.svelte-1tnnkq8{grid-template-columns:1fr}}.proceed-section.svelte-1tnnkq8.svelte-1tnnkq8{text-align:center;padding-top:2rem;border-top:1px solid #e9ecef}.proceed-button.svelte-1tnnkq8.svelte-1tnnkq8{background:#007bff;color:white;border:none;border-radius:8px;padding:1rem 2rem;font-size:1.1rem;font-weight:600;cursor:pointer;transition:all 0.3s ease;display:inline-flex;align-items:center;gap:0.5rem}.proceed-button.svelte-1tnnkq8.svelte-1tnnkq8:hover{background:#0056b3;transform:translateY(-1px);box-shadow:0 4px 12px rgba(0, 123, 255, 0.3)}.placeholder.svelte-1tnnkq8.svelte-1tnnkq8{text-align:center;padding:4rem 2rem;color:#666}.generation-header.svelte-1tnnkq8.svelte-1tnnkq8{display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem}.generation-header.svelte-1tnnkq8 h2.svelte-1tnnkq8{margin:0;color:#333}.back-button.svelte-1tnnkq8.svelte-1tnnkq8{background:white;color:#495057;border:1px solid #dee2e6;border-radius:6px;padding:0.5rem 1rem;font-size:0.9rem;cursor:pointer;transition:all 0.2s}.back-button.svelte-1tnnkq8.svelte-1tnnkq8:hover:not(:disabled){background:#e9ecef}.back-button.svelte-1tnnkq8.svelte-1tnnkq8:disabled{opacity:0.5;cursor:not-allowed}.loading-state.svelte-1tnnkq8.svelte-1tnnkq8{text-align:center;padding:4rem 2rem}.spinner.svelte-1tnnkq8.svelte-1tnnkq8{width:50px;height:50px;border:4px solid #f3f3f3;border-top:4px solid #007bff;border-radius:50%;animation:svelte-1tnnkq8-spin 1s linear infinite;margin:0 auto 1.5rem auto}@keyframes svelte-1tnnkq8-spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}.loading-state.svelte-1tnnkq8 p.svelte-1tnnkq8{font-size:1.1rem;color:#495057;margin:0.5rem 0}.loading-hint.svelte-1tnnkq8.svelte-1tnnkq8{font-size:0.9rem !important;color:#999 !important}.progress-log.svelte-1tnnkq8.svelte-1tnnkq8{max-width:600px;margin:2rem auto 0;text-align:left;background:#f8f9fa;border-radius:8px;padding:1rem;max-height:400px;overflow-y:auto}.progress-message.svelte-1tnnkq8.svelte-1tnnkq8{display:flex;align-items:flex-start;gap:0.75rem;padding:0.5rem;margin-bottom:0.5rem;border-radius:4px;font-size:0.9rem;line-height:1.4}.progress-message.svelte-1tnnkq8 .icon.svelte-1tnnkq8{flex-shrink:0;font-weight:bold;font-size:1.1rem}.progress-message.info.svelte-1tnnkq8.svelte-1tnnkq8{background:#e7f3ff;color:#004085}.progress-message.info.svelte-1tnnkq8 .icon.svelte-1tnnkq8{color:#0056b3}.progress-message.success.svelte-1tnnkq8.svelte-1tnnkq8{background:#d4edda;color:#155724}.progress-message.success.svelte-1tnnkq8 .icon.svelte-1tnnkq8{color:#28a745}.progress-message.warning.svelte-1tnnkq8.svelte-1tnnkq8{background:#fff3cd;color:#856404}.progress-message.warning.svelte-1tnnkq8 .icon.svelte-1tnnkq8{color:#ffc107}.progress-message.error.svelte-1tnnkq8.svelte-1tnnkq8{background:#f8d7da;color:#721c24}.progress-message.error.svelte-1tnnkq8 .icon.svelte-1tnnkq8{color:#dc3545}.progress-message.svelte-1tnnkq8 .message-text.svelte-1tnnkq8{flex:1;word-wrap:break-word}.error-state.svelte-1tnnkq8.svelte-1tnnkq8{text-align:center;padding:3rem 2rem;background:#f8d7da;border:1px solid #f5c6cb;border-radius:8px}.error-icon.svelte-1tnnkq8.svelte-1tnnkq8{font-size:3rem;color:#721c24;margin-bottom:1rem}.error-state.svelte-1tnnkq8 h3.svelte-1tnnkq8{color:#721c24;margin:0 0 0.5rem 0}.error-state.svelte-1tnnkq8 p.svelte-1tnnkq8{color:#721c24;margin:0 0 1.5rem 0}.retry-button.svelte-1tnnkq8.svelte-1tnnkq8{background:#dc3545;color:white;border:none;border-radius:6px;padding:0.75rem 1.5rem;font-size:1rem;font-weight:600;cursor:pointer;transition:all 0.2s}.retry-button.svelte-1tnnkq8.svelte-1tnnkq8:hover{background:#c82333}.empty-generation.svelte-1tnnkq8.svelte-1tnnkq8{text-align:center;padding:4rem 2rem}.empty-generation.svelte-1tnnkq8 p.svelte-1tnnkq8{font-size:1.1rem;color:#666;margin-bottom:2rem}.generate-button.svelte-1tnnkq8.svelte-1tnnkq8{background:#007bff;color:white;border:none;border-radius:8px;padding:1rem 2rem;font-size:1.1rem;font-weight:600;cursor:pointer;transition:all 0.3s ease}.generate-button.svelte-1tnnkq8.svelte-1tnnkq8:hover{background:#0056b3;transform:translateY(-1px);box-shadow:0 4px 12px rgba(0, 123, 255, 0.3)}.result-section.svelte-1tnnkq8.svelte-1tnnkq8{display:flex;flex-direction:column;gap:1.5rem}.generation-meta.svelte-1tnnkq8.svelte-1tnnkq8{background:#d4edda;border:1px solid #c3e6cb;border-radius:8px;padding:1rem;text-align:center}.retry-info.svelte-1tnnkq8.svelte-1tnnkq8{color:#155724;font-weight:600;margin:0}.validation-warnings.svelte-1tnnkq8.svelte-1tnnkq8{background:#fff3cd;border:1px solid #ffeaa7;border-radius:8px;padding:1rem 1.5rem}.validation-warnings.svelte-1tnnkq8 h4.svelte-1tnnkq8{color:#856404;margin:0 0 0.75rem 0;font-size:1rem}.validation-warnings.svelte-1tnnkq8 ul.svelte-1tnnkq8{margin:0;padding-left:1.5rem;color:#856404}.validation-warnings.svelte-1tnnkq8 li.svelte-1tnnkq8{margin-bottom:0.5rem;line-height:1.5}.action-buttons.svelte-1tnnkq8.svelte-1tnnkq8{display:flex;justify-content:center;gap:1rem}.btn-secondary.svelte-1tnnkq8.svelte-1tnnkq8{background:white;color:#495057;border:1px solid #dee2e6;border-radius:6px;padding:0.75rem 1.5rem;font-size:1rem;font-weight:600;cursor:pointer;transition:all 0.2s;display:flex;align-items:center;gap:0.5rem}.btn-secondary.svelte-1tnnkq8.svelte-1tnnkq8:hover{background:#e9ecef}',
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1u006gg_START -->${$$result.title = `<title>Pedagogue - Module Generator</title>`, ""}<!-- HEAD_svelte-1u006gg_END -->`, ""} <div class="container svelte-1tnnkq8"><header class="svelte-1tnnkq8" data-svelte-h="svelte-18kz6uh"><h1 class="svelte-1tnnkq8">Pedagogue</h1> <p class="svelte-1tnnkq8">AI-powered module specification generator for peer-led courses</p></header> <div class="workflow svelte-1tnnkq8"><nav class="steps svelte-1tnnkq8">${each(steps, (step, index) => {
    return `<div class="${[
      "step svelte-1tnnkq8",
      ($currentStep === index + 1 ? "active" : "") + " " + ($currentStep > index + 1 ? "completed" : "")
    ].join(" ").trim()}"><span class="step-number svelte-1tnnkq8">${escape(index + 1)}</span> <span class="step-name svelte-1tnnkq8">${escape(step)}</span> </div>`;
  })}</nav> <main class="content svelte-1tnnkq8"> ${$currentStep === 1 ? `<section class="upload-section svelte-1tnnkq8"><h2 class="svelte-1tnnkq8" data-svelte-h="svelte-qgdr5y">Upload Module Files</h2> <p class="svelte-1tnnkq8" data-svelte-h="svelte-1vdkls3">Upload your three XML files to begin: project briefs, additional
            skills, and research topics.</p> <div class="upload-areas svelte-1tnnkq8">${validate_component(FileUpload, "FileUpload").$$render(
    $$result,
    {
      fileType: "projects",
    ...
    {},
    {}
  )}</div> ${$canProceedToStep2 ? `<div class="proceed-section svelte-1tnnkq8"><button type="button" class="proceed-button svelte-1tnnkq8" data-svelte-h="svelte-obni2h">Continue to Context →</button></div>` : ``}</section>` : `${$currentStep === 2 ? `<section class="analysis-section">${validate_component(StructuredInputForm, "StructuredInputForm").$$render($$result, { formData: $structuredInput }, {}, {})}</section>` : `${$currentStep === 3 ? `<section class="generation-section"><div class="generation-header svelte-1tnnkq8"><h2 class="svelte-1tnnkq8" data-svelte-h="svelte-1mdfre8">Module Generation</h2> <button type="button" class="back-button svelte-1tnnkq8" ${""}>← Back to Context</button></div> ${`${`${`<div class="empty-generation svelte-1tnnkq8"><p class="svelte-1tnnkq8" data-svelte-h="svelte-1na1esz">Ready to generate your module specification</p> <button type="button" class="generate-button svelte-1tnnkq8" data-svelte-h="svelte-64s30s">Generate Module</button></div>`}`}`}</section>` : `<section class="placeholder svelte-1tnnkq8"><p>Step ${escape($currentStep)} - ${escape(steps[$currentStep - 1])}</p> <p data-svelte-h="svelte-1qplcr6">Implementation coming soon...</p></section>`}`}`}</main></div> </div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-eef3827d.js.map
