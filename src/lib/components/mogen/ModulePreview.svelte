...
<div class="module-preview">
	<div class="preview-header">
		...
		<div class="preview-actions">
			<button type="button" class="btn-secondary" on:click={copyToClipboard} disabled={!xmlContent}>
				📋 Copy
			</button>
			<button
				type="button"
	...
	{#if validation}
		<div class="validation-status" class:valid={validation.valid} class:invalid={!validation.valid}>
			{#if validation.valid}
	...
	<div class="preview-content">
		{#if xmlContent}
			<pre class="xml-preview"><code>{@html highlightXML(xmlContent)}</code></pre>
		{:else}
			<div class="empty-state">
				<p>No module specification generated yet</p>
				<p class="hint">Fill in the form and click "Generate Module" to create a specification</p>
			</div>
		{/if}
	</div>
</div>
